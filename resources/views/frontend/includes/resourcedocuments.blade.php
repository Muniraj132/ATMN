        ...
        <div class="row cards">
            ...
            <div class="row">
                <div class="col-md-12">
                    <br>
                    <div class="php-email-form">
                        <table id="resourcedocuments" class="table table-hover responsive resourcedocuments data-table" style="width:100%">
                            <thead>
                              <tr>
              ...
              <div class="modal-dialog modal-md modal-centered">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <button class="btn btn-add m-t-15 waves-effect mb-3" id="resourceFilesUpdate" style="background-color: #801214;color:#fff;" >{!! trans('main.update') !!}</button>
...
<script type="text/javascript">
    ...
    var table = $('.resourcedocuments').DataTable({
      ...
      columns: [
          {data: 'resource', name: 'Name',orderable: true, searchable: true},

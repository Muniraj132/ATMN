...
<div class="col-md-9">
    ...
    @if(isset($data))
        <form  action="{{ route('ds.app.update', ATMNHelper::encryptUrl($data->id)) }}" role="form" class="php-email-form" method="post">
            @method('put')
    ...
    @endif
        ...
        <select class="select-district" name="district_id" value="{{ $data->d_id ?? ''}}">
                ...
                <option value="{!! $value->d_id !!}" {{ $data->district_id  == $value->d_id ? 'selected' : '' }}>{!! $value->district !!}</option>
                @endforeach
         </select>
         <input type="hidden" name="district_id" value="{{ $data-> district_id ?? '' }}">
                  ...
                  <div class="col-md-12">
                    <div class="row">
                      ...
                      <div class="form-group col-md-5">
                        ...
                        <input  type="text" class="form-control" name="cell_phone" id="cell_phone" placeholder="{!! trans('main.user.cell.phone') !!}" value="{{ $data->cell_phone ?? '' }}">
                    ...
                    <div class="row">
                      <div class="form-group col-md-7">
                       ...
                       <div class="form-group col-md-5">
                        ...
                        <input  type="text" class="form-control" name="office_phone" id="office_phone" placeholder="{!! trans('main.user.office.phone') !!}" value="{{ $data->title ?? '' }}">
                  ...
                  <div class="col-md-12">
                    <div class="row">
                      <div class="col form-group col-md-3.5">
                        ...
                        <input  type="date" name="app_sent" class="form-control" id="app_sent" placeholder="{!! trans('main.user.app.sent') !!}"  value="{{ $data->app_sent ?? '' }}">
                      ...
                      <div class="col form-group col-md-3.5">
                        ...
                        <input  type="date" name="app_received" class="form-control" id="app_received" placeholder="{!! trans('main.user.app.received') !!}" value="{{ $data->app_received ?? '' }}">
                      ...
                      <div class="form-group col-md-5">
                        ...
                        <input  type="text" class="form-control" name="church_serving" id="" placeholder="{!! trans('main.user.church.serving') !!}" value="{{ $data->church_serving ?? '' }}">
                  ...
                  <div class="col-md-12">
                    <div class="row">
                      <div class="col form-group col-md-3.5">
                        ...
                        <input  type="date" name="atmn_certified" class="form-control" id="atmn_certified" placeholder="{!! trans('main.user.atmn.certified') !!}" value="{{ $data->atmn_certified ?? '' }}" >
                  ...
                  <div class="col-md-12">
                    <div class="row">
                      <div class="form-group col-md-7">
                        ...
                        <input  type="text" class="form-control" name="district_issuing" id="district_issuing" placeholder="{!! trans('main.user.district.issuing') !!}" value="{{ $data->district_issuing ?? '' }}">
                  ...
                  <div class="col-md-12">
                    <div class="row">
                      ...
                      <div class="form-group col-md-5">
                        ...
                        <input  type="text" class="form-control" name="license" id="license" placeholder="{!! trans('main.user.license') !!}" value="{{ $data->license ?? '' }}">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="row">
                      <div class="form-group col-md-7">
                        <input  type="checkbox" name="send_mail" id="send_mail" placeholder="{!! trans('main.user.send.mail') !!}" value="{{ $data->send_mail ?? '' }}Y">
                  ...
                  <div class="col-md-12">
                    <div class="row">
                      <div class="form-group col-md-7">
                        ...
                        <!-- <input  type="text" class="form-control" name="home_address" id="home_address" placeholder="{!! trans('main.user.home.address') !!}" > -->
                ...
                <div class="text-center"><button type="submit">{{ @$data->id ? 'Approve' : trans('main.submit') }}</button></div>

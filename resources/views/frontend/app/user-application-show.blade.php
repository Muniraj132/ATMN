...
<div class="col-md-9">
    ...
    @endif
        ...
        <select disabled="disabled" class="select-district" name="district_id" value="{{ $data->d_id ?? ''}}">
                  ...
                  <div class="col-md-12">
                    <div class="row">
                      <div class="form-group col-md-7">
                        ...
                        <select disabled="disabled" class="form-select" value="{{ $data->status ?? '' }}" >
                  ...
                  <div class="col-md-12">
                    <div class="row">
                      ...
                      <div class="col form-group col-md-3.5">
                        ...
                        <select disabled="disabled" name="affiliation" class="form-select" value="{{ $data->affiliation ?? '' }}">
                          <option>Not Selected</option>
                      ...
                      <div class="form-group col-md-5">
                        ...
                        <select disabled="disabled" name="ministry_area"class="form-select" value="{{ $data->ministry_area ?? '' }}">
                          <option>Not Selected</option>
                  ...
                  <div class="col-md-12">
                    <div class="row">
                      <div class="form-group col-md-7">
                       ...
                       <textarea disabled="disabled" class="form-control" name="home_address" rows="3" placeholder="{!! trans('main.user.home.address') !!}" value="{{ $data->home_address ?? '' }}"></textarea>
                      ...
                      <div class="form-group col-md-5">
                        ...
                        <textarea disabled="disabled" class="form-control" name="comments" rows="3" placeholder="{!! trans('main.user.comments') !!}" >{{ $data->comments ?? '' }}</textarea>
                ...
                <input disabled="disabled" type="hidden" name="status" value="approve">
                <input disabled="disabled" type="hidden" name="user_id" value="{{$data->user_id}}">
                <input disabled="disabled" type="hidden" name="ds_id" value="{{$user->id}}">
                ...
                <div class="text-center"><button type="submit">{{ @$data->id ? 'Print' : 'Print' }}</button></div>
               </form>

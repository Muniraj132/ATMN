    ...
    @endif
     ...
     <div class="row">
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="form-group col-md-6">
              ...
              <label class="label-name"><strong>  @if (Route::has('login'))
          @auth
            {{ Auth::user()->name }}
          @endauth
        @endif</strong></label>
            ...
            <div class="form-group col-md-6" align="end">
              ...
              <label class="label-name"><strong><input type="text" name="pastor" class="underline bri-date" id="pastor" value="{{Carbon\Carbon::now()->format('m-d-Y')}}" ></strong></label>
            </div>
          </div>
        </div>
      </div> 
        ...
        <div class="col-md-12">
          <div class="row">
            ...
            <div class="form-group col-md-6" align="end">
              ...
              <input type="text" name="pastor" class="underline church-name" id="pastor">
            </div>
          </div>
        </div>
      </div>  
        ...
        <div class="col-md-12">
          <div class="row">
            ...
            <div class="form-group col-md-12 ">
              ...
              <textarea class="form-control" name="personal_wellbeing_are_you_exited" >{{$data->personal_wellbeing_are_you_exited ?? '' }}</textarea>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-12">
          <div class="row">
            ...
            <div class="form-group col-md-12 ">
              ...
              <textarea class="form-control" name="overview_church_health_prayer_attention" >{{$data->overview_church_health_prayer_attention ?? '' }}</textarea>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-12">
          <div class="row">
            ...
            <div class="form-group col-md-12 spec-concern">
              ...
              <textarea class="form-control" name="specific_concern_restoring_hope">{{$data->specific_concern_developing_culture_of_prayer ?? ''}}</textarea>
              ...
              <div class="sub-">
                ...
                <textarea class="form-control" name="specific_concern_developing_culture_of_prayer">{{$data->specific_concern_developing_culture_of_prayer ?? ''}}</textarea>
              </div>
              ...
              <textarea class="form-control" name="specific_concern_rebuilding_mission"  >{{$data->specific_concern_rebuilding_mission ?? ''}}</textarea>
              ...
              <textarea class="form-control" name="specific_concern_recruit_lay_leaders" >{{$data->specific_concern_recruit_lay_leaders ?? ''}}</textarea>
              ...
              <textarea class="form-control" name="specific_concern_reset_governance"  >{{$data->specific_concern_reset_governance ?? ''}}</textarea>
              ...
              <textarea class="form-control" name="specific_concern_resolve_conflict" >{{$data->specific_concern_resolve_conflict ?? ''}}</textarea>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-12">
          <div class="row">
            ...
            <div class="form-group col-md-12 ">
             ...
             <textarea class="form-control" name="other_objectives_outline"  >{{$data->other_objectives_outline ?? '' }}</textarea>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="row">
            ...
            <div class="form-group col-md-12 ">
              <textarea class="form-control" name="greatest_priority_for_next_month"  >{{$data->greatest_priority_for_next_month ?? '' }}</textarea>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="row">
            ...
            <div class="form-group col-md-12 ">
              <textarea class="form-control" name="mou_with_church" >{{$data->mou_with_church ?? '' }}</textarea>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-12">
          <div class="row">
            ...
            <div class="col form-group col-md-12">
              <textarea class="form-control" name="ds_comments" placeholder="DS Comments" rows="4">{{$data->ds_mou_with_church ?? '' }}</textarea>
            </div>
          </div>
        </div>
      </div>
      ...
      @endif
    	...
    	@if($isUSER=='ds')
            <button type="submit">{{ trans('main.approve') }}</button>

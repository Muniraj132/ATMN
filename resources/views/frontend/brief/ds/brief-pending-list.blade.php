   ...
   @endif
    ...
    <table id="example" class="table table-hover responsive" style="width:100%">
        ...
        <tbody>
            ...
            <td>
              <a href="{{url('recruitment/brief/dsshow',array(ATMNHelper::encryptUrl(@$value->id)))}}" class="get_view" data-id="{{$value->id}}"><i class="fa fa-eye"></i></a>
              <a href="{{url('recruitment/brief/dsedit',array(ATMNHelper::encryptUrl(@$value->id)))}}"><i class="fa fa-edit" ></i></a>

     ...
     <div class="row">
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="form-group col-md-6">
              ...
              <label class="label-name"><strong> {!! ATMNHelper::getName(@$data->user_id) !!}</strong></label>
            </div>
      ...
      <div class="text-center">
        @if(@$data->brief_status == 'Pending')
          <a href="{{Route('briefadminpendinglist')}}" style="color: #fff; background: #801214; padding: 11px 22px 11px 21px; border-radius: 5px;"onmouseover="">Close</a>
        @else
          <a href="{{Route('briefadminapprovedlist')}}" style="color: #fff; background: #801214; padding: 11px 22px 11px 21px; border-radius: 5px;"onmouseover="">Close</a>
        @endif
      </div>
      </form>
      </div>

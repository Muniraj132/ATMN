          ...
          <div class="content-wrapper">
                ...
                <div class="row">
                  <div class="col form-group col-md-4">
                        ...
                        <input type="text" class="form-control" name="street1" id="street1" placeholder="{!! trans('main.user.street1') !!}" value="{{ $street1 ?? '' }}" >
                      </div>
                  <div class="col form-group col-md-4">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-4">
                    <label class="label-name">{!! trans('main.user.city') !!} <span class="astrict">*</span></label>
                     <input type="text" class="form-control" name="city" id="city" placeholder="{!! trans('main.user.city') !!}" value="{{ $city ?? '' }}" >
                  </div>
                  <div class="form-group col-md-4">
                  ...
                  <div class="col-md-12">
                    <div class="row">
                      ...
                      <div class="form-group col-md-1">
                        ...
                        @endif
                        @if($self_assessment != '')
                        <span><a href="{{asset('uploads').'/'.$user_id.'/'.$self_assessment}}" data-toggle="tooltip" title="Click here to download uploaded Application Part I" download><i class="fa fa-download"></i> </a></span>
                        @endif
                      </div>
                      <div class="form-group col-md-8">
                        ...
                        <span class="file-name">
                          @if($self_assessment != '')
                          <a href="{{asset('uploads').'/'.$user_id.'/'.$self_assessment}}" data-toggle="tooltip" title="Click here to download uploaded Application Part I" download>{{ $self_assessment ?? ''}}</a>
                          @endif
                        </span>
                      </div>
                    </div>
      ...
      <form id="storestep4">
                ...
                <div class="col-md-12">
                  <div class="row" style="margin-left: 7px;flex-wrap: nowrap;">
                    <span style="width:130px;">
                      <input type="checkbox" class="form-check-input" name="submit_status" id="status" value="Approve" />
                      <label>Approve</label>
                    </span>
                    <span style="width:130px;">
                      <input type="checkbox" class="form-check-input" name="submit_status" id="status" value="Pending" @if($submit_status == "Pending") checked="checked" @endif  @if($submit_status == 'Awaiting') disabled="disabled" @endif/>
                      <label>Pending</label>
                    </span>
                    <span style="width:130px;">
                      <input type="checkbox" class="form-check-input" name="submit_status" id="status" value="Awaiting" 
                      @if( $submit_status == "Awaiting") checked="checked" @endif />
            ...
            <div class="row">
              <table id="pastorcomments" class="table table-hover responsive" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                      <td style="width: 200px">{{$value->church_name}}</td>
                     
                      <td style="width: 100px">{{ \Carbon\Carbon::createFromTimestamp(strtotime($value->assign_end_date ?? ''))->format('m-d-Y')}}</td>
                      <td style="width:100px">{{ATMNHelper::getName($value->assigned_by)}}</td>
                      <td><a href="" class="get_view" data-id="{{$value->id}}"><i class="fa fa-eye"></i></a>
        ...
        <div class="actions clearfix">
          <ul role="menu" aria-label="Pagination" style="border-bottom: 1px solid #f5f5f4;">
            ...
            @endif
            <li class="" aria-disabled="false">
              <a href="{{Route('app.adminapplicationlist')}}" style="color: #fff;">Close</a>
            </li>
          </ul>
        </div>
      </form>
        ...
        success: function(response) {
          if(response.state != ''){
            ...
            $.each (response.state, function (data) {
              // console.log( 'Utah' == response.state[data]);
...
// To get the path, you can use:
  ...
  if(last_part == "edit#step4#status-section"){
      $("#one").removeClass("current");
      $("#two").removeClass("current");
      $("#three").removeClass("current");
      $("#four").addClass("current");

          ...
          <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8"><label>{!! ATMNHelper::getname(@$user_id) !!}</label></div>
                </div>
                <!-- <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="row">
                      ...
                      <div class="form-group col-md-8">
                        ...
                        <span class="file-name">
                        @if($application_part_II != '')
                        <span><a href="{{asset('uploads').'/'.$user_id.'/'.$application_part_II}}" data-toggle="tooltip" title="Click here to download uploaded Application Part II" download>{{ $application_part_II ?? ''}}</a>
                        @endif
                        </span>
                  ...
                  <div class="col-md-12">
                    <div class="row">
                      ...
                      <div class="form-group col-md-1">
                        ...
                        @endif
                        @if($background_check != '')
                        <span><a href="{{asset('uploads').'/'.$user_id.'/'.$background_check}}" data-toggle="tooltip" title="Click here to download Background Checks" download><i class="fa fa-download"></i> </a></span>
                        @endif
                      </div>
                      <div class="form-group col-md-8">
                        <span class="form-control choose-file">
                        ...
                        <span class="file-name">
                        @if($background_check != '')
                        <a href="{{asset('uploads').'/'.$user_id.'/'.$background_check}}" data-toggle="tooltip" title="Click here to download Background Checks" download>{{ $background_check ?? ''}}</a>
                        @endif
                        </span>
                      </div>
                    </div>
        ...
        <div class="content-wrapper">
          <div class="col-md-12">
            ...
            <div class="row" style="font-size:14px">
              <div class="col-md-4">
                <strong><label>Submitted Date</label></strong><br>
                <label>{{ \Carbon\Carbon::createFromTimestamp(strtotime($data->app_sent ?? ''))->format('m-d-Y')}}</label>
              </div>
              <div class="col-md-4">
                <strong><label>Status</label></strong><br>
                <label>{{ \Carbon\Carbon::createFromTimestamp(strtotime($data->app_sent ?? ''))->format('m-d-Y')}}</label>
              </div>
              <div class="col-md-4">
                <strong><label>Application Status</label></strong><br>
                <label>{{ $status }}</label>
              </div>
            </div>            
            @endif -->
      ...
      <div class="actions clearfix">
        <ul role="menu" aria-label="Pagination" style="border-bottom: 1px solid #f5f5f4;">
          ...
          <li class="" aria-disabled="false">
            ...
            @else
            <a href="{{Route('app.dspendinglist')}}" style="color: #fff;" onmouseover="">Close</a>
            @endif
          </li>
          @endif
          ...
          <li class="" aria-disabled="false">
            ...
            <a href="{{ route('app.adminapplicationlist') }}" style="color: #fff;" onmouseover="">Close</a>
            @else
            <a href="{{Route('app.dsapprovedlist')}}" style="color: #fff;" onmouseover="">Close</a>
            @endif
          </li>
          @endif 
  ...
  $.ajax({
    ...
    data : data,
      success: function(response) {
        ...
        console.log(response.unavailabeData['start_date']);
        console.log(response.unavailabeData['end_date']);
        console.log(response.unavailabeData['reason']);

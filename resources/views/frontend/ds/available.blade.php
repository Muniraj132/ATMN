...
<div class="col-md-9" id="bri_ind_container">       
    <div class="search-container">
        ...
        <div class="row cards">
            <div class="row bar">
            @if(Request::path() == 'recruitment/ds-placed-list')
                <label>{!! ATMNHelper::getdistrictname($d_id) !!} - Pastor Placed</label>
            @endif
            @if(Request::path() == 'recruitment/ds-available-list')
                <label>{!! ATMNHelper::getdistrictname($d_id) !!} - Pastor Available</label>
            @endif
            </div>
            <br>
                    ...
                    <table id="example" class="table table-hover responsive" style="width:100%">
                        ...
                        <tbody>
                            @if(Request::path() == 'recruitment/ds-placed-list')
                                ...
                                <tr>
                                    <td>
                                    <a href="{{route('ds.app.show',array(ATMNHelper::encryptUrl($value->atmn_id)))}}" target="_blank">   
                                        @if($value->title != null)
                                            {{$value->title}}.&nbsp;
                                    ...
                                    <td>
                                        <a href="{{route('ds.app.show',array(ATMNHelper::encryptUrl($value->atmn_id)))}}#step4#status-section" target="_blank">
                                            Approved
                                        </a>
                                    </td>
                                    <td>
                                    ...
                                    <!-- <td>
                                        <a href="{{route('ds.app.show',array(ATMNHelper::encryptUrl($value->atmn_id)))}}" target="_blank"><i class="fa fa-eye"></i></a>
                                    </td> -->
                                </tr>
                                @endforeach
                            @endif
                            ...
                            @if(Request::path() == 'recruitment/ds-available-list')
                                ...
                                <tr>
                                    ...
                                    <!-- <td><a href="{{route('ds.app.show',array(ATMNHelper::encryptUrl($value->atmn_id)))}}" target="_blank" ><i class="fa fa-eye"></i></a></td> -->
                                </tr>
                                @endforeach
                            @endif
                        </tbody>

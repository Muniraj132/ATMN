      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav flex-row">
            ...
            <li class="nav-item mr-auto"><a class="navbar-brand" href="vertical-modern-menu-template/index.html"><img class="brand-logo" alt="stack admin logo" src="{{ URL::to('public/admin/images/logo/stack-logo-light.png') }}">
                <h2 class="brand-text">YR Institute</h2></a></li>
                ...
                <ul class="mega-dropdown-menu dropdown-menu row">
                  <li class="col-md-2 col-sm-6">
                    ...
                    <div id="mega-menu-carousel-example">
                      <div><img class="rounded img-fluid mb-1" src="{{ URL::to('public/admin/images/logo/stack-logo-light.png') }}" alt="First slide"><a class="news-title mb-0 d-block" href="#">Poster Frame PSD</a>
                  ...
                  <li class="col-md-3 col-sm-6">
                    ...
                    <ul>
                      <li class="menu-list">
                        <ul>
                          <li><a class="dropdown-item" href="vertical-modern-menu-template/layout-fixed.html"><i class="ft-file"></i> Page layouts</a></li>
                          <li><a class="dropdown-item" href="vertical-modern-menu-template/color-palette-primary.html"><i class="ft-camera"></i> Color pallet</a></li>
                          ...
                          <li><a class="dropdown-item" href="vertical-modern-menu-template/changelog.html"><i class="ft-minimize-2"></i> Change log</a></li>
                  ...
                  <li class="col-md-3 col-sm-6">
                    ...
                    <div class="mt-1" id="accordionWrap" role="tablist" aria-multiselectable="true">
                      <div class="card border-0 box-shadow-0 collapse-icon accordion-icon-rotate">
                        <div class="card-header p-0 pb-2 border-0" id="headingOne" role="tab"><a data-toggle="collapse" href="vertical-modern-menu-template.html#accordionOne" aria-expanded="true" aria-controls="accordionOne">Accordion Item #1</a></div>
                        ...
                        <div class="card-header p-0 pb-2 border-0" id="headingTwo" role="tab"><a class="collapsed" data-toggle="collapse" href="vertical-modern-menu-template.html#accordionTwo" aria-expanded="false" aria-controls="accordionTwo">Accordion Item #2</a></div>
                        <div class="card-collapse collapse" id="accordionTwo" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordionWrap" aria-expanded="false">
                          <div class="card-content">
                        ...
                        <div class="card-header p-0 pb-2 border-0" id="headingThree" role="tab"><a class="collapsed" data-toggle="collapse" href="vertical-modern-menu-template.html#accordionThree" aria-expanded="false" aria-controls="accordionThree">Accordion Item #3</a></div>
            ...
            <ul class="nav navbar-nav float-right">
              ...
              <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon ft-mail"></i><span class="badge badge-pill badge-warning badge-up">3</span></a>
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                  ...
                  <li class="scrollable-container media-list"><a href="javascript:void(0)">
                      <div class="media">
                        <div class="media-left"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="{{ URL::to('public/admin/images/portrait/small/avatar-s-1.png') }}" alt="avatar"><i></i></span></div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left"><span class="avatar avatar-sm avatar-busy rounded-circle"><img src="{{ URL::to('public/admin/images/portrait/small/avatar-s-2.png') }}" alt="avatar"><i></i></span></div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="{{ URL::to('public/admin/images/portrait/small/avatar-s-3.png') }}" alt="avatar"><i></i></span></div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left"><span class="avatar avatar-sm avatar-away rounded-circle"><img src="{{ URL::to('public/admin/images/portrait/small/avatar-s-6.png') }}" alt="avatar"><i></i></span></div>
                        <div class="media-body">
              ...
              <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="avatar avatar-online"><img src="{{ URL::to('public/admin/images/portrait/small/avatar-s-1.png') }}" alt="avatar"><i></i></span><span class="user-name">{!! Auth::user()->name !!}</span></a>
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="{{ url('profileView') }}/{{ auth()->user()->id }}"><i class="ft-user"></i> Edit Profile</a>
                    <a class="dropdown-item" href="vertical-modern-menu-template/app-email.html"><i class="ft-mail"></i> My Inbox</a><a class="dropdown-item" href="vertical-modern-menu-template/user-cards.html"><i class="ft-check-square"></i> Task</a><a class="dropdown-item" href="vertical-modern-menu-template/app-chat.html"><i class="ft-message-square"></i> Chats</a>

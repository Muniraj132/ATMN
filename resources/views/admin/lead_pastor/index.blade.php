            ...
            <section class="panel">
                ...
                @if(@$data)
                	...
                	<tr class="gradeX" id="<?php echo $value->id; ?>">
                        ...
                        <a href="{{route('lead-pastor.destroy',array($value->id))}}" onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-icon waves-effect waves-light btn-danger m-b-5"><i class="fa fa-trash-o"></i></a>
                        </td>
                	</tr>	
                    @endforeach
                @endif
...
<div class="modal fade" id="lead_pastor" role="dialog">
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Lead Pastor Leadership</h4>
          
              </div>
        <div class="modal-body">
            <div class="clearfix">&nbsp;</div>
            <div class="col-md-12">
              <div class="col-md-4"><strong>{!! trans('Please answer these questions regarding your perceptions as a member of the pastoral/ministerial staff') !!}</strong></div>
          </div>
          <div class="clearfix">&nbsp;</div>
          <div class="col-md-12">
              <div class="col-md-4"><strong>{!! trans('Do you cultivate relationships with other district pastors?') !!}</strong></div>
              <div class="col-md-8"><span class="q1"></span></div>
          </div>
           <div class="clearfix">&nbsp;</div>
          <div class="col-md-12">
              <div class="col-md-4"><strong>{!! trans('Do you have relationships with other district pastors who hold you accountable?') !!}</strong></div>
              <div class="col-md-8"><span class="q2"></span></div>
          </div>
           <div class="clearfix">&nbsp;</div>
          <div class="col-md-12">
              <div class="col-md-4"><strong>{!! trans('Are you supported by your Elders/Governing Board?') !!}</strong></div>
              <div class="col-md-8"><span class="q3"></span></div>
          </div>
           <div class="clearfix">&nbsp;</div>
          <div class="col-md-12">
              <div class="col-md-4"><strong>{!! trans('Does your Elder/Governing Board hold you accountable to clear expectations?') !!}</strong></div>
              <div class="col-md-8"><span class="q4"></span></div>
          </div>
           <div class="clearfix">&nbsp;</div>
           <div class="col-md-12">
              <div class="col-md-4"><strong>{!! trans('Do you hold your staff/volunteers to clear expectations?') !!}</strong></div>
              <div class="col-md-8"><span class="q5"></span></div>
          </div>
          <div class="clearfix">&nbsp;</div>
           <div class="col-md-12">
              <div class="col-md-4"><strong>{!! trans('Do you empower your staff/volunteers to minister in their roles effectively?') !!}</strong></div>
              <div class="col-md-8"><span class="q6"></span></div>
          </div>
          <div class="clearfix">&nbsp;</div>
           <div class="col-md-12">
              <div class="col-md-4"><strong>{!! trans('Do you feel supported by the District Staff?') !!}</strong></div>
...
<script type="text/javascript">
        ...
        function viewPopup(id){
            ...
            var setUrl = "{{ URL::to('lead_pastor') }}/"+id;
            $.ajax({
                url: setUrl,
                type: 'GET',
                async: true,
                ...
                success: function(data){
                    if(data){
                        ...
                        var setData = getData['leadpastor'];
